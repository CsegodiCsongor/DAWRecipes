...
namespace RecipesDAW
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RecipesDAWContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("RecipesDAWContext")));

            services.AddIdentity<IdentityUser, IdentityRole>()
               .AddDefaultTokenProviders()
               .AddEntityFrameworkStores<RecipesDAWContext>();

            //services.AddDbContext<Data.RecipesDAWContext>(options =>
            //        options.UseSqlServer(Configuration.GetConnectionString("RecipesDAWContext")));
        }
